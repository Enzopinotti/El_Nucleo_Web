const services = ["Videoclips", "Publicidad", "Cortometrajes", "Coberturas"] as const;
    ...
    <div className="site-shell">
      ...
      <main id="main-content">
        <section className="hero" id="top" aria-labelledby="hero-title">
          <p className="eyebrow">Proyecto original 2022 · reconstrucción 2026</p>
          <h1 id="hero-title">El Núcleo</h1>
          <p className="hero__lead">
            Una identidad audiovisual que vuelve a construirse con una base moderna sin borrar el
            proyecto con el que empezó esta historia.
          </p>
        ...
        <section className="history-section" id="historia" aria-labelledby="history-title">
          ...
          <div className="history-grid">
            <article>
              ...
              <p>
                HTML, SCSS, Bootstrap y una estructura multipágina para presentar un colectivo de
            ...
            <article>
              ...
              <p>
                React, TypeScript, Vite, pruebas y CI reproducible, con accesibilidad y
                mantenibilidad como parte del contrato técnico.
              </p>
            </article>
          </div>
        </section>
        ...
        <section className="services-section" id="servicios" aria-labelledby="services-title">
          <p className="section-kicker">Contenido histórico, arquitectura nueva</p>
          ...
          <p className="section-note">
            Esta fase todavía no presenta estos servicios como una oferta comercial actual. Primero
            se preserva y verifica el contenido original; luego se decide qué información sigue
            vigente.
          </p>
        </section>
        ...
        <section className="foundation-section" id="foundation" aria-labelledby="foundation-title">
          <div>
            ...
            <h2 id="foundation-title">Una base verificable antes de migrar las cinco páginas</h2>
          </div>
      ...
      <footer className="site-footer">
        <p>El Núcleo · proyecto histórico de Enzo Pinotti · modernización 2026</p>
      </footer>
    </div>
  );
}
